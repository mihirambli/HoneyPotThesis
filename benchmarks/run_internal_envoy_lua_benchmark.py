...
Writes machine-readable results to:
  benchmarks/results/internal_envoy_lua_profile.json   (summary stats, microseconds)
  benchmarks/results/internal_envoy_lua_raw.json       (raw per-request samples, microseconds)
  benchmarks/results/e2e_envoy_lua_wadm.json           (end-to-end k6 latency, milliseconds)
"""
...
# directly comparable.
E2E_EDGE = "envoy_lua"
E2E_EDGE_CONFIG = "envoy/envoy.yaml"
...
def main() -> int:
    ...
    raw_output_file = results_dir / "internal_envoy_lua_raw.json"
    ...
    e2e_output_file = results_dir / "e2e_envoy_lua_wadm.json"
