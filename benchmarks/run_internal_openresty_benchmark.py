...
Writes machine-readable results to:
  benchmarks/results/internal_openresty_profile.json   (summary stats, microseconds)
  benchmarks/results/internal_openresty_raw.json       (raw per-request samples, microseconds)
  benchmarks/results/e2e_openresty_wadm.json           (end-to-end k6 latency, milliseconds)
"""
...
# directly comparable.
E2E_EDGE = "openresty"
E2E_EDGE_CONFIG = "nginx/nginx.conf"
...
def main() -> int:
    ...
    e2e_output_file = results_dir / "e2e_openresty_wadm.json"
